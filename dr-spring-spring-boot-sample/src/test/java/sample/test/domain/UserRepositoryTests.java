...
public class UserRepositoryTests {
	...
	@Test
	public void findByUsernameFromSQL() throws Exception {
		User user = this.repository.findByUsername("sframework");
		assertThat(user.getUsername()).isEqualTo("sframework");
		assertThat(user.getVin()).isEqualTo(new VehicleIdentificationNumber("01234567890123456"));
	}
